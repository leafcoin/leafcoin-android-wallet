...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "leafcoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;

	public static final String BLOCKCHAIN_FILENAME = "blockchain" + FILENAME_NETWORK_SUFFIX;

	public static final String CHECKPOINTS_FILENAME = "checkpoints" + FILENAME_NETWORK_SUFFIX;

	private static final String BLOCKEXPLORER_BASE_URL_PROD = "http://explorer.leafco.in/";
	private static final String BLOCKEXPLORER_BASE_URL_TEST = "https://explorer.leafco.in/testnet/"; //LEAF: Not yet...
	...
	public static final String MIMETYPE_PAYMENTREQUEST = "application/leafcoin-paymentrequest"; // BIP 71
	public static final String MIMETYPE_PAYMENT = "application/leafcoin-payment"; // BIP 71
	public static final String MIMETYPE_PAYMENTACK = "application/leafcoin-paymentack"; // BIP 71
	public static final String MIMETYPE_TRANSACTION = "application/x-leaftx";

	public static final int MAX_NUM_CONFIRMATIONS = 3;
	public static final String USER_AGENT = "Leafcoin Wallet";
	...
	public static final String CURRENCY_CODE_BTC = "LEAF";
	public static final String CURRENCY_CODE_MBTC = "mLEAF";
	...
	public static final String DONATION_ADDRESS = "fVn8q33XSKDmiFxBszdeFGYbb7CG69oHen";
	public static final String REPORT_EMAIL = "leafcoincrypto@gmail.com";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/leafcoin/leafcoin-android-wallet/";
	public static final String BINARY_URL = "https://github.com/leafcoin/leafcoin-android-wallet/";
	public static final String CREDITS_BITCOINJ_URL = "https://github.com/leafcoin/leafcoin-new";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
	public static final String CREDITS_ICON_URL = "http://leafco.in/";
	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/leafcoin";
	public static final String AUTHOR_GOOGLEPLUS_URL = "https://plus.google.com/leafcoin";
